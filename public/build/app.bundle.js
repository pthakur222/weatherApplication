...
var Weather = function (_React$Component) {
    ...
    _createClass(Weather, [{
        key: 'enterLocation',
        value: function enterLocation(e) {
        ...
        value: function handleRadioChange(e) {
            ...
            if (x === 'C') {
                ...
                this.setState({ temp: celsius + '\xB0C' });
            } else {
                var far = celsius * (9 / 5) + 32;
                this.setState({ checked: false });
                this.setState({ temp: far + '\xB0F' });
            }
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            var tempData = [_react2.default.createElement(
                'div',
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'h4',
                        null,
                        this.state.temp ? this.state.temp : this.state.resultantData.temperature + '\xB0C'
                    )
                ),
                _react2.default.createElement(
                    'div',
                    ...
                    _react2.default.createElement(
                        ...
                        null,
                        'Pressure : ',
                        this.state.resultantData.pressure,
                        '%'
                    ),
                    _react2.default.createElement(
                        'h6',
                        null,
                        'Humidity : ',
                        this.state.resultantData.humidity,
                        '%'
                    ),
                    _react2.default.createElement(
                        'h6',
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            'h6',
                                            { className: 'location col-xs-6' },
                                            'Location'
                                        ),
                                        '  ',
                                        _react2.default.createElement('input', { type: 'text', className: 'col-xs-6', value: this.state.location, onChange: this.enterLocation.bind(this), onBlur: this.handleClick.bind(this) })
                                    )
                                ),
                                _react2.default.createElement(
                                    'div',
                                    ...
                                    _react2.default.createElement(
                                        ...
                                        _react2.default.createElement(
                                            'label',
                                            { className: 'label' },
                                            _react2.default.createElement('input', { type: 'radio', className: 'radio-button-input', name: 'optionradio', value: 'C', checked: this.state.checked, onChange: this.handleRadioChange.bind(this) }),
                                            '\xB0C'
                                        ),
                                        _react2.default.createElement(
                                            'label',
                                            { className: 'label' },
                                            _react2.default.createElement('input', { type: 'radio', className: 'radio-button-input', name: 'optionradio', value: 'F', onChange: this.handleRadioChange.bind(this) }),
                                            '\xB0F'
                                        )
                                    )
                                )
...
var _weather = __webpack_require__(6);
